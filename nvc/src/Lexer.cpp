...
Lexer::Lexer(const std::string& input) : input(input), pos(0), line(1), col(1) {
    keywords = {"अस्ति", "वद", "यदि", "तर्हि", "चक्र", "अन्यथा", "फलम्", "विधिः", "नित्य", "दर्शनम्", "दृश्यम्", "मंजूषा", "सूची", "चित्त्रम्", "प्रविष्टिः", "क्रिया", "सूत्रम्", "योगः", "आह्वानम्", "चलच्चित्रम्", "अभिलेखः", "समयः", "कालमापकः"};
    devanagariDigits = {
        {"०", "0"}, {"१", "1"}, {"२", "2"}, {"३", "3"}, {"४", "4"},
        {"५", "5"}, {"६", "6"}, {"७", "7"}, {"८", "8"}, {"९", "9"}
    };
